...
public class GameManager : MonoBehaviour
{
    ...
    public void PlayerDamage(float damage, Vector3 player)
    {
        ...
        if (darkBar >= 100)
        {
            ...
            GameObject.FindFirstObjectByType<UltimateAttacks>().powerUpActive = (true);
            DrainAttackBars(darkBar, darkBarSlider);
        }
    }
    public void EnemyDamage(float damage)
    {
        ...
        if (lightBar >= 100)
        {
            ...
            DrainAttackBars(lightBar, lightBarSlider);
        }   
    }
    ...
    private void DrainAttackBars(float currentValue, Slider currentSlider)
    {
        ...
        GameObject.FindFirstObjectByType<UltimateAttacks>().powerUpActive = (false);
